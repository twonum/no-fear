...
import { renderFurniturePredictions } from "../utils/render-predictions-furniture"
...
const FurnitureDetection = () => {
                ...
                detectInterval = setInterval(() => {
                    if (
                        ...
                        net
                            .detect(video)
                            .then((predictions) => {
                                renderFurniturePredictions(predictions, context);
                                const detectedObject = predictions.find((p) =>
                                    furnitureList.includes(p.class)
                                );
                                if (detectedObject) {
    ...
    const handleObjectDetection = (detectedObject) => {
        curDetectedObject = detectedObject;
...
export default FurnitureDetection;
