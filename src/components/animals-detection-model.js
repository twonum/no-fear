...
import { renderAnimalsPredictions } from "../utils/render-predictions-animals";
                ...
                detectInterval = setInterval(() => {
                    if (
                        ...
                        net
                            .detect(video)
                            .then((predictions) => {
                                renderAnimalsPredictions(predictions, context);
                                const detectedObject = predictions.find((p) =>
                                    animalsList.includes(p.class)
                                );
...
export default AnimalsDetection;
